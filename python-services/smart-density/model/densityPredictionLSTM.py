## 通过过去分流阀开度、开度变化率、液位、液位变化率预测未来悬浮液密度变化
...
inputIntervel = readMikongData(desired, startDay, days)
#[密度，阀门开度，变化率，液位，变化率]
...
weight_path = 'predDensity-5feature-5stepsIn-1StpesOut-20241116test1.model.keras'  # 保存模型路径及文件名
